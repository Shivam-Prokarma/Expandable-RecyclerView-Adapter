package com.prokarma.expandablerecycleradapter;
...
import com.prokarma.expandablerecycleradapter.listeners.ExpandCollapseListener;
import com.prokarma.expandablerecycleradapter.listeners.GroupExpandCollapseListener;
...
import com.prokarma.expandablerecycleradapter.model.ExpandableGroup;
import com.prokarma.expandablerecycleradapter.model.ExpandableList;
import com.prokarma.expandablerecycleradapter.model.ExpandableListPosition;
import com.prokarma.expandablerecycleradapter.viewholders.ChildViewHolder;
import com.prokarma.expandablerecycleradapter.viewholders.GroupViewHolder;
...
public abstract class ExpandableRecyclerViewAdapter<GVH extends GroupViewHolder, CVH extends ChildViewHolder>
    ...
    public void onGroupCollapsed(int positionStart, int itemCount) {
        ...
        if (itemCount > 0) {
            notifyItemRangeRemoved(positionStart + 1, itemCount - 1);
            if (expandCollapseListener != null) {
    ...
    /**
     * Trigger by click of @{@link ChildViewHolder}
     */
    @Override
    public void onChildClick() {
        //TODO action on click opf child.
    }
